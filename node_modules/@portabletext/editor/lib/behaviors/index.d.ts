...
): PickFromUnion_2<BehaviorAction, 'type', 'execute'>
 ...
 * @beta
 */
export declare function noop(): PickFromUnion_2<BehaviorAction, 'type', 'noop'>
...
export declare type SyntheticBehaviorEvent =
  ...
  | {
      type: StrictExtract_2<SyntheticBehaviorEventType, 'move.backward'>
      distance: number
    }
  | {
